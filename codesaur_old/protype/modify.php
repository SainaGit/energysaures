...
$sql = "SELECT * FROM protype WHERE ID = $modID";
$result = dbQuery($sql);
if(dbNumRows($result) > 0)
{
    ...
    if($Image_mn && $Image_mn != "&")
    {
        ...
        $img_mn = WEB_ROOT . PROTYPE_IMAGES_DIR . $thumbImg_mn;
        $imgDel_mn = 1;    
    }   
    ...
    if($Image_en && $Image_en != "&")
    {
        ...
        $img_en = WEB_ROOT . PROTYPE_IMAGES_DIR . $thumbImg_en;
        $imgDel_en = 1;    
    }
?>
            ...
            <form action="execute.php?action=modify" method="post" enctype="multipart/form-data" name="frmMain" id="frmMain">
                ...
                <div id="divPictureChoose_mn" class="input_field">
                     ...
                     <div style="float: left; margin-left: 10px; margin-top: 10px;"> 
                        <a href="<?php echo CMS_ROOT . 'protype/execute.php?action=picture_mn&id=' . $ID; ?>"> зураг устгах</a>
                     </div>
                     <?php } ?>
                     <div class="clear">
                     </div>
                ...
                <div id="divPictureChoose_en" class="input_field">
                     ...
                     <?php if($imgDel_en) { ?>
                     <div style="float: left; margin-left: 10px; margin-top: 10px;"> 
                        <a href="<?php echo CMS_ROOT . 'protype/execute.php?action=picture_en&id=' . $ID; ?>"> зураг устгах</a>
                     </div>
                     <?php } ?>
                     <div class="clear">
                     </div>
