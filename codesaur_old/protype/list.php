...
$rowsPerPage = 50;
$sql = "SELECT * FROM protype ORDER BY Rank, DateCreated DESC";
...
<table cellspacing="0" cellpadding="0">
    ...
    ?>
        <tr <?php if($i%2 == 0) { echo 'class="alt"'; }?> > 
            <td><?php echo showProTypePath(GetProType($ID)); ?></td>
    ...
    ?>
        <tr>
            <td colspan="6">Нарийвчилсан төрөл бүртгэгдээгүй байна.</td>
        </tr>
    <?php
    }
    ?>
...
<div style="text-align: right; padding-top: 10px;">
    <input type="button" class="button" onclick="add();" value="Нарийвчилсан төрөл нэмэх" />
</div>
