...
$rowsPerPage = 50;
$sql = "SELECT * FROM maintype ORDER BY Rank, DateCreated DESC";
...
<table cellspacing="0" cellpadding="0">
    ...
    ?>
        <tr <?php if($i%2 == 0) { echo 'class="alt"'; }?> >
            <td><img width="<?php echo THUMBNAIL_WIDTH; ?>px" src="<?php echo $img_mn; ?>"  /></td> 
            <td><?php echo showMainTypePath(GetMainType($ID)); ?></td>
    ...
    ?>
        <tr>
            <td colspan="6">Ерөнхий төрөл бүртгэгдээгүй байна.</td>
        </tr>
    <?php
    }
    ?>
...
<div style="text-align: right; padding-top: 10px;">
    <input type="button" class="button" onclick="add();" value="Ерөнхий төрөл нэмэх" />
</div>
